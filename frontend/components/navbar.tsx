          ...
          >
            ...
            >
              ...
              >
                ...
                <div
                  className="absolute inset-0 bg-gradient-to-r from-teal-400/20 via-blue-500/20 to-purple-500/20 blur-xl opacity-0 group-hover/nav:opacity-100 transition-opacity duration-500"
                  suppressHydrationWarning
                />
              ...
              <div className="scale-90 origin-left" suppressHydrationWarning>
