...
export function FacebookPagePlugin({
  ...
  }, [pageUrl, width, height, showCover, showFacepile, smallHeader, tabs]); // Re-run when these props change

  return (
    <div className="facebook-page-plugin overflow-hidden rounded-xl bg-white" style={{ minHeight: height, minWidth: width }}>
